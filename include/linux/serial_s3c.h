...
#define S5L87XX_UFSTAT_TXFULL  (1<<9)
#define S5L87XX_UFSTAT_TXMASK  (15<<4)
#define S5L87XX_UFSTAT_TXSHIFT (4)
...
#define APPLE_S5L_UCON_RXTO_ENA		7
...
#define APPLE_S5L_UTRSTAT_RXTO		(1<<3)
